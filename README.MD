...
**major.minor.patch-d.d.d-{alpha|beta|gold}**
...
The second tuple of `d.d.d` is the version of Unreal Engine this release is compatible with. This means there could be multiple versions of Reasonable Planning AI to indicate UE compatibility.
