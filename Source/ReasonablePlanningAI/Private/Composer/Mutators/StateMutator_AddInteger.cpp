...
void UStateMutator_AddInteger::ReceiveMutate_Implementation(UReasonablePlanningState* StateToMutate) const
{
...
bool UStateMutator_AddInteger::CanApply_Implementation(const UReasonablePlanningState* StateToMutate) const
{
    switch(StatePropertyToMutate.ExpectedValueType)
    {
        case EStatePropertyType::Float:
