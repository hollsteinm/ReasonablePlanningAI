...
#include "Composer/ActionTasks/ActionTask_RotateTo.h"
#include "AIController.h"
#include "GameFramework/Pawn.h"
#include "Core/ReasonablePlanningState.h"

UActionTask_RotateTo::UActionTask_RotateTo()
	: Precision(10.f)
{
...
void UActionTask_RotateTo::ReceiveStartActionTask_Implementation(AAIController* ActionInstigator, UReasonablePlanningState* CurrentState, AActor* ActionTargetActor, UWorld* ActionWorld)
{
...
void UActionTask_RotateTo::ReceiveUpdateActionTask_Implementation(AAIController* ActionInstigator, UReasonablePlanningState* CurrentState, float DeltaSeconds, AActor* ActionTargetActor, UWorld* ActionWorld)
{
...
void UActionTask_RotateTo::ReceiveCancelActionTask_Implementation(AAIController* ActionInstigator, UReasonablePlanningState* CurrentState, AActor* ActionTargetActor, UWorld* ActionWorld)
{
	ActionInstigator->ClearFocus(EAIFocusPriority::Gameplay);
}

void UActionTask_RotateTo::PostInitProperties()
{
	Super::PostInitProperties();
	PrecisionDot = FMath::Cos(FMath::DegreesToRadians(Precision));
}

void UActionTask_RotateTo::PostLoad()
{
	Super::PostLoad();
	PrecisionDot = FMath::Cos(FMath::DegreesToRadians(Precision));
}
